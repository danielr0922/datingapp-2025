...
{
    public class MembersController(AppDbContext context) : BaseApiController  //We inject AppDb Context: When a request is received it routes it to the correct controller
